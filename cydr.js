...
<<<<<<< HEAD
  window.Cydr = (function() {
    ...
    Cydr._eventDispatcher = null;

    Cydr.prototype.getEventDispatcher = function() {
      var _ref;

      if ((_ref = this._eventDispatcher) == null) {
        this._eventDispatcher = new Cydr.EventDispatcher();
      }
  ...
  Cydr.EventDispatcher = (function() {
    function EventDispatcher() {
      this._events = [];
    }

    EventDispatcher.prototype.fire = function(sku) {
      var func, i, id, subscribers, _results;

      subscribers = this._events[sku] || [];
      i = 0;
=======
  window.Cydr = {};
...
<<<<<<< HEAD
    ...
    EventDispatcher.prototype.subscribe = function(sku, listener, func) {
      if (!this._events[sku]) {
        this._events[sku] = [];
      }
      return this._events[sku]["listener_" + listener.__ID__] = func.bind(listener);
    };
...
<<<<<<< HEAD
    Binding.prototype.getParentBinding = function() {
      var node;
...
>>>>>>> 8227c9728629c840b26ee8f217ecbb003fc8585d
  ...
  Cydr.ContentBinding = (function(_super) {
    ...
    function ContentBinding() {
      _ref = ContentBinding.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  Cydr.SubmitBinding = (function(_super) {
    ...
    function SubmitBinding() {
      _ref1 = SubmitBinding.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  Cydr.ValueBinding = (function(_super) {
    ...
    function ValueBinding() {
      _ref2 = ValueBinding.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
    ...
    ValueBinding.prototype.importValue = function() {
      var opt, _i, _len, _ref3, _results;

      if (this.element.tagName === "INPUT") {
        return this.element.value = this.getValue();
      } else if (this.element.tagName === "SELECT") {
        _ref3 = this.element.options;
        _results = [];
    ...
    ValueBinding.prototype.exportValue = function() {
      ...
      if (this.element.tagName === "INPUT") {
        ...
        val = (_ref3 = this.element.options[this.element.selectedIndex]) != null ? _ref3.getAttribute("value") : void 0;
        if (val == null) {
          val = "";
        }
  ...
  Cydr.CheckedBinding = (function(_super) {
    ...
    function CheckedBinding() {
      _ref3 = CheckedBinding.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  Cydr.JSONBinding = (function(_super) {
    ...
    function JSONBinding() {
      _ref4 = JSONBinding.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
...
>>>>>>> 8227c9728629c840b26ee8f217ecbb003fc8585d
  ...
  Cydr.ExtraclassesBinding = (function(_super) {
    ...
    function ExtraclassesBinding() {
      _ref5 = ExtraclassesBinding.__super__.constructor.apply(this, arguments);
      return _ref5;
    }

    ExtraclassesBinding.prototype.importValue = function() {
<<<<<<< HEAD
      var cssClass, exec, newClass, result, rx, _ref6;

      _ref6 = this.executeBindingExpression();
      for (cssClass in _ref6) {
        exec = _ref6[cssClass];
=======
...
>>>>>>> 8227c9728629c840b26ee8f217ecbb003fc8585d
  ...
  Cydr.AttrBinding = (function(_super) {
    ...
    function AttrBinding() {
      _ref6 = AttrBinding.__super__.constructor.apply(this, arguments);
      return _ref6;
    }

    AttrBinding.prototype.importValue = function() {
      var attribute, exec, _ref7, _results;
  ...
  Cydr.VisibleBinding = (function(_super) {
    ...
    function VisibleBinding() {
      _ref7 = VisibleBinding.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  Cydr.HiddenBinding = (function(_super) {
    ...
    function HiddenBinding() {
      _ref8 = HiddenBinding.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  Cydr.ClickBinding = (function(_super) {
    ...
    function ClickBinding() {
      _ref9 = ClickBinding.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
  ...
  Cydr.LoopBinding = (function(_super) {
    ...
    LoopBinding.prototype.loadTemplate = function() {
      var dummy, n, nodes, sib, _i, _j, _len, _len1, _ref10, _ref11, _results;

      _ref10 = this.element.getElementsByTagName("*");
      ...
      this.clearContents();
      _ref11 = dummy.getElementsByTagName("*");
    ...
    LoopBinding.prototype.importValue = function() {
      ...
      return list.each(function(model) {
        var cachedNodes, n, node, _i, _j, _len, _len1, _ref10, _results, _results1;
  ...
  Cydr.OptionsBinding = (function(_super) {
    ...
    function OptionsBinding() {
      _ref10 = OptionsBinding.__super__.constructor.apply(this, arguments);
      return _ref10;
    }
...
<<<<<<< HEAD
      list = this.model.executeBindingExpression();
=======
      list = this.executeBindingExpression();
>>>>>>> 8227c9728629c840b26ee8f217ecbb003fc8585d
      return list.each(function(model) {
  ...
  Cydr.Text = (function(_super) {
    ...
    function Text() {
      _ref11 = Text.__super__.constructor.apply(this, arguments);
      return _ref11;
    }
    ...
    Text.prototype.toString = function() {
      ...
      return (_ref12 = this.getValue()) != null ? _ref12.toString().replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;") : void 0;
    };
  ...
  Cydr.HTMLText = (function(_super) {
    ...
    function HTMLText() {
      _ref12 = HTMLText.__super__.constructor.apply(this, arguments);
      return _ref12;
    }
...
>>>>>>> 8227c9728629c840b26ee8f217ecbb003fc8585d
    ...
    function Model(data) {
      var f, name, prop, type, val, _ref14, _ref15, _ref16, _ref17, _ref18;

      Model.__super__.constructor.call(this);
      this._mutatedProperties = {};
      this._mutatedCollections = {};
      _ref14 = this.properties;
      for (name in _ref14) {
        type = _ref14[name];
        if (!((_ref15 = Cydr[type]) != null ? _ref15.isDataType : void 0)) {
      ...
      _ref16 = this.has_many;
      for (name in _ref16) {
        type = _ref16[name];
        if (!((_ref17 = window[type]) != null ? _ref17.isModel : void 0)) {
...
<<<<<<< HEAD
      ...
      if (!Cydr._cachedExpressions[this.getClass()][exp]) {
        ...
        Cydr._cachedExpressions[this.getClass()][exp] = new Function("scope", "binding", body);
=======
      var body, f, ret;
...
<<<<<<< HEAD
    ...
    Model.prototype.bindToElement = function(el, viewModel) {
=======
      var _ref, _ref1;
...
<<<<<<< HEAD
    Model.prototype.applyBindingsToNode = function(node, viewModel) {
=======
...
<<<<<<< HEAD
      Cydr.prototype.getEventDispatcher().fire("ModelUpdated:" + (this.getClass()) + ":" + prop + ":" + (this.getID()));
=======
...
<<<<<<< HEAD
    Model.prototype.setViewModel = function(vm) {
      return this.viewModel = vm;
    };

    Model.prototype.getViewModel = function() {
      return this.viewModel || this;
=======
...
>>>>>>> 8227c9728629c840b26ee8f217ecbb003fc8585d
  ...
  Cydr.DataList = (function(_super) {
    ...
    DataList.prototype.execute = function() {
      var field, filterData, i, model, operator, _i, _j, _k, _len, _len1, _len2, _ref14, _ref15, _ref16, _ref17,
        _this = this;
      ...
      if (this.filters.length) {
        ...
        for (_i = 0, _len = _ref14.length; _i < _len; _i++) {
          filterData = _ref14[_i];
          _ref15 = filterData.filter.split(":"), field = _ref15[0], operator = _ref15[1];
          if (!operator) {
            operator = "EqualTo";
          }
          switch (operator) {
...
<<<<<<< HEAD
    ...
    ViewModel.prototype._eventDispatcher = null;
    ...
    function ViewModel(selector) {
      ...
      if (node) {
        node.parent = this;
        this.applyBindingsToNode(node, this);
=======
